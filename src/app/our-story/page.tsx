        ...
        <div className={styles.founderInner}>
          ...
          <div className={styles.founderImageWrap}>
            ...
            <div className={styles.founderBadge}>
              <span className={styles.founderBadgeLabel}>CEO &amp; Founder</span>
          ...
          <div className={styles.founderContent}>
            ...
            <div className={styles.founderBody}>
              <div style={{ marginBottom: '1.5rem', paddingBottom: '1.5rem', borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
                <p style={{ margin: 0, fontWeight: 600, color: 'var(--charcoal)', fontSize: '1.1rem' }}>CEO & Founder, Arema Foods International</p>
