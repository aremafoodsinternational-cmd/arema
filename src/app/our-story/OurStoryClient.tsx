            ...
            <div className={styles.founderBody}>
              <div style={{ marginBottom: '1.5rem', paddingBottom: '1.5rem', borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ margin: 0, fontSize: '0.95rem' }}>
                  <a href={`mailto:${t('ourStoryPage.founderEmail') || 'nibeesh.jb@gmail.com'}`} style={{ color: 'var(--arema-brown)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    {t('ourStoryPage.founderEmail') || 'nibeesh.jb@gmail.com'}
                  </a>
                </p>
              </div>
