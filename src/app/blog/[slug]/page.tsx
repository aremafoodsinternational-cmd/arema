    ...
    <main style={{ paddingTop: 'var(--nav-height)', background: 'var(--light-surface)' }}>
      ...
      <div style={{ position: 'relative', width: '100%', height: '480px', overflow: 'hidden' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 'var(--space-2)', alignItems: 'center', marginBottom: 'var(--space-2)' }}>
            ...
            <span style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-2xs)', color: 'rgba(250,248,245,0.55)' }}>{article.readTime}</span>
            <span style={{ width: 3, height: 3, borderRadius: '50%', background: 'rgba(250,248,245,0.4)' }} />
            <span style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-2xs)', color: 'rgba(250,248,245,0.55)' }}>{article.date}</span>
          </div>
          <h1 style={{
      ...
      <article style={{
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-xs)', fontWeight: 600, color: 'var(--dark-text)', margin: 0 }}>{article.author}</p>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-2xs)', color: 'var(--charcoal-60)', margin: 0 }}>{article.authorRole}</p>
          </div>
        </div>
