...
export default function WhyAremaSection() {
  ...
  const langPillars = currentTranslations.whyArema.pillars || [];
      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div ref={leftRef} className={styles.left}>
            <span className={styles.eyebrow}>{t('whyArema.eyebrow')}</span>
          ...
          <div ref={pillarsRef} className={styles.pillars} id="why-arema-pillars">
            {langPillars.map((p, idx) => (
              <div key={idx} className={styles.pillar} data-pillar>
                <div className={styles.icon}>{pillarsIcons[idx]}</div>
