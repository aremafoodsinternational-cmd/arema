...
const advantages = [
  {
    title: 'Bharathapuzha',
    desc: 'Fertile alluvial soil enriched by the river.',
    icon: (
  ...
  {
    title: 'GI Tagged',
    desc: 'Government certified Palakkad Matta Rice.',
    icon: (
  ...
  {
    title: 'Traditional Aging',
    desc: 'Naturally aged to retain nutrients and taste.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10" />
  ...
  },
  {
    ...
    desc: 'The 80% table, preserved with care.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'From farm to table, fully traceable.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div ref={leftRef} className={styles.left}>
            <span className={styles.eyebrow}>THE PALAKKAD ADVANTAGE</span>
          ...
          <div ref={cardsRef} className={styles.advantages}>
            {advantages.map((adv) => (
              <div key={adv.title} className={styles.card} data-adv-card>
